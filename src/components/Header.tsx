...
export default function Header() {
  return (
    <header className="flex justify-between items-center sticky top-0 bg-white z-50 shadow-md divide-x">
      {/* left */}
      <div className="flex justify-center items-center p-2">
        ...
        >
          <defs></defs>
          <g id="Layer_3">
            <path id="Layer_3-2" className="" d="M0,0H150V150H0V0Z" />
          </g>
          <path
            fill="#000"
      ...
      {/* right */}
      <div className="p-2 font-light text-sm text-gray-500">
